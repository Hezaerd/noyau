...
| Client Runtime | `packages/client-runtime/` | Runtime renderer : Session RPC, superviseur, primitives Atom, Projection Shell. Transport Web câblé. |
...
apps/web     ──consomme──> packages/client-runtime   (Session, superviseur, Shell)
