    ...
    <SelectPrimitive.Portal {...portalProps}>
      ...
      >
        ...
        >
          ...
          <div className="surface-overlay relative h-full min-w-(--anchor-width) in-data-[side=none]:min-w-[calc(var(--anchor-width)+1.75rem)] rounded-lg border before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-[0_1px_--theme(--color-black/4%)] dark:before:shadow-[0_-1px_--theme(--color-white/6%)]">
