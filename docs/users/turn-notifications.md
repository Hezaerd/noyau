# Notice when a turn finishes

Noyau can notify you when an agent finishes a turn while you work elsewhere.

## Use turn notifications
...
1. Open **Settings**.
2. Select **General**.
3. Change **Turn end notifications**.

This setting controls operating-system notifications. The app icon badge continues to show waiting threads.
