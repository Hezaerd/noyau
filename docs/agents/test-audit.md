...
| `apps/web/test/composer-drafts.test.ts` | Brouillons isolés par Thread / Project ; images session-only ; persist texte-only. | Chrome persisté, images hors localStorage. |
