...
type TicketCommandInput = TicketCommandRequestType | (typeof TicketCommandRequest)["Encoded"]

const request = (input: TicketCommandInput) => Schema.decodeUnknownSync(TicketCommandRequest)(input)
